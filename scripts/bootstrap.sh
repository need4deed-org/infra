...
echo "  --from-literal=SMTP_HOST=mail.infomaniak.com \\"
echo "  --from-literal=SMTP_PORT=587 \\"
echo "  --from-literal=SMTP_USER=<verify-smtp-user> \\"
echo "  --from-literal=SMTP_PASS=<verify-smtp-password> \\"
echo "  --from-literal=EMAIL_FROM_NOTIFY=coordinators@need4deed.org \\"
echo "  --from-literal=SMTP_NOTIFY_HOST=mail.infomaniak.com \\"
echo "  --from-literal=SMTP_NOTIFY_PORT=587 \\"
echo "  --from-literal=SMTP_NOTIFY_USER=coordinators@need4deed.org \\"
echo "  --from-literal=SMTP_NOTIFY_PASS=<notify-smtp-password> \\"
